...
function BlurWord({ word, trigger }: { word: string; trigger: number }) {
  ...
  const gradientColors = ["#f3d6c3", "#e8c996", "#d9a760", "#f0c987", "#f3d6c3"];
    ...
    >
      <defs>
        <linearGradient id="orn-grad" x1="0" y1="0" x2="400" y2="400" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="#d9a760" />
          <stop offset="0.5" stopColor="#d9a760" />
          <stop offset="1" stopColor="#d9a760" />
        </linearGradient>
      </defs>
    ...
    <section className="bg-grain relative min-h-screen flex flex-col justify-center items-start overflow-hidden bg-[#140c08]">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 30% 50%, rgba(217,167,96,0.10) 0%, rgba(217,167,96,0.04) 45%, transparent 70%)",
          }}
        />
      </div>
