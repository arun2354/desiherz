...
function Hero() {
  ...
  return (
    <section ref={containerRef} id="top" className="relative min-h-screen flex items-center pt-32 pb-24 overflow-hidden" style={{ background: "#09050a" }}>
      <div className="max-w-7xl mx-auto w-full px-6 grid md:grid-cols-12 gap-12 lg:gap-20 items-center">
        
        {/* Left — Editorial Text */}
        <div ref={textRef} className="md:col-span-7 z-10 flex flex-col items-start pt-10">
          <p className="eyebrow mb-6 uppercase" style={{ fontSize: "0.6rem", letterSpacing: "0.4em", color: "#c9a04a" }}>
            Est. MMXXV · By Invitation
          </p>
          <h1 className="font-display font-normal" style={{ fontSize: "clamp(3.2rem, 6.5vw, 6rem)", lineHeight: 1.05, color: "#f5ede0", letterSpacing: "-0.02em" }}>
            A quieter way<br />
            <em style={{ color: "#c9a04a", fontStyle: "italic" }}>to find</em> forever.
          </h1>
          <p className="mt-8 font-sans leading-relaxed" style={{ color: "rgba(245,237,224,0.65)", fontSize: "1.05rem", maxWidth: "480px" }}>
            A private matrimony house for discerning families — a considered, human alternative to the noise of the modern marriage market. We accept a small circle each season.
          </p>
          
          <div className="mt-12 flex flex-wrap items-center gap-8">
            <a href="#contact" className="inline-block font-sans uppercase" style={{
                padding: "1.2rem 2.4rem",
                fontSize: "0.65rem",
                letterSpacing: "0.25em",
                color: "#c9a04a",
                border: "1px solid rgba(201,160,74,0.5)",
                background: "rgba(61,12,24,0.25)",
                transition: "all 0.4s ease"
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.background = "rgba(61,12,24,0.7)";
                e.currentTarget.style.borderColor = "#c9a04a";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.background = "rgba(61,12,24,0.25)";
                e.currentTarget.style.borderColor = "rgba(201,160,74,0.5)";
              }}
            >
              Request an Invitation
            </a>
            <a href="#about" className="font-sans uppercase" style={{
                fontSize: "0.65rem",
                letterSpacing: "0.25em",
                color: "#c9a04a",
        ...
        {/* Right — Vertically Cropped Parallax Image */}
        <div className="md:col-span-5 relative w-full h-[70vh] lg:h-[80vh] overflow-hidden" style={{ border: "1px solid rgba(201,160,74,0.15)" }}>
          <img
            ref={imageRef}
            src={coupleHero}
            alt="DesiHerz Couple"
            className="absolute top-[-10%] left-0 w-full h-[120%] object-cover"
            style={{ filter: "brightness(0.8) contrast(1.1) sepia(0.1)" }}
          />
          {/* Elegant dark gradient overlay from bottom */}
          <div className="absolute inset-0" style={{ background: "linear-gradient(to top, rgba(9,5,10,0.8) 0%, transparent 40%)" }} />
          <div className="absolute bottom-6 left-6 right-6 flex justify-between font-sans uppercase" style={{ fontSize: "0.55rem", letterSpacing: "0.3em", color: "rgba(201,160,74,0.8)" }}>
            <span>PL. XIV</span>
            <span>Frankfurt · 2025</span>
          </div>
        </div>
